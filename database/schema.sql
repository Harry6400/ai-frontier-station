...
CREATE TABLE IF NOT EXISTS ai_content (
  ...
  content_type VARCHAR(50) NOT NULL COMMENT '内容类型，如paper、news、product_update、arena、practice',
  sub_category VARCHAR(50) DEFAULT NULL COMMENT '子分类，如3d_ct_denoising、medical_imaging、large_model',
...
CREATE TABLE IF NOT EXISTS ai_content_external_ref (
  ...
  stars INT DEFAULT NULL COMMENT 'GitHub Star 数',
